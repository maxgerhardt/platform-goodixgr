...
env.Append(
    ...
    CPPPATH=[
        ...
        os.path.join(FRAMEWORK_DIR, "components", "profiles", "ams_c"),
        os.path.join(FRAMEWORK_DIR, "components", "profiles", "ancs_c"),
        os.path.join(FRAMEWORK_DIR, "components", "profiles", "ans"),
        os.path.join(FRAMEWORK_DIR, "components", "profiles", "ans_c"),
        os.path.join(FRAMEWORK_DIR, "components", "profiles", "bas"),
        os.path.join(FRAMEWORK_DIR, "components", "profiles", "bas_c"),
        os.path.join(FRAMEWORK_DIR, "components", "profiles", "bcs"),
        os.path.join(FRAMEWORK_DIR, "components", "profiles", "bps"),
        os.path.join(FRAMEWORK_DIR, "components", "profiles", "common"),
        os.path.join(FRAMEWORK_DIR, "components", "profiles", "cscs"),
        os.path.join(FRAMEWORK_DIR, "components", "profiles", "cts"),
        os.path.join(FRAMEWORK_DIR, "components", "profiles", "cts_c"),
        os.path.join(FRAMEWORK_DIR, "components", "profiles", "dis"),
        os.path.join(FRAMEWORK_DIR, "components", "profiles", "dis_c"),
        os.path.join(FRAMEWORK_DIR, "components", "profiles", "gls"),
        os.path.join(FRAMEWORK_DIR, "components", "profiles", "gus"),
        os.path.join(FRAMEWORK_DIR, "components", "profiles", "gus_c"),
        os.path.join(FRAMEWORK_DIR, "components", "profiles", "hids"),
        os.path.join(FRAMEWORK_DIR, "components", "profiles", "hrrcps"),
        os.path.join(FRAMEWORK_DIR, "components", "profiles", "hrs"),
        os.path.join(FRAMEWORK_DIR, "components", "profiles", "hrs_c"),
        os.path.join(FRAMEWORK_DIR, "components", "profiles", "hts"),
        os.path.join(FRAMEWORK_DIR, "components", "profiles", "ias"),
        os.path.join(FRAMEWORK_DIR, "components", "profiles", "lls"),
        os.path.join(FRAMEWORK_DIR, "components", "profiles", "lms"),
        os.path.join(FRAMEWORK_DIR, "components", "profiles", "ndcs"),
        os.path.join(FRAMEWORK_DIR, "components", "profiles", "otas"),
        os.path.join(FRAMEWORK_DIR, "components", "profiles", "otas_c"),
        os.path.join(FRAMEWORK_DIR, "components", "profiles", "pass"),
        os.path.join(FRAMEWORK_DIR, "components", "profiles", "pass_c"),
        os.path.join(FRAMEWORK_DIR, "components", "profiles", "pcs"),
        os.path.join(FRAMEWORK_DIR, "components", "profiles", "rscs"),
        os.path.join(FRAMEWORK_DIR, "components", "profiles", "rscs_c"),
        os.path.join(FRAMEWORK_DIR, "components", "profiles", "rtus"),
        os.path.join(FRAMEWORK_DIR, "components", "profiles", "sample"),
        os.path.join(FRAMEWORK_DIR, "components", "profiles", "ths"),
        os.path.join(FRAMEWORK_DIR, "components", "profiles", "ths_c"),
        os.path.join(FRAMEWORK_DIR, "components", "profiles", "thscps"),
        os.path.join(FRAMEWORK_DIR, "components", "profiles", "tps"),
        os.path.join(FRAMEWORK_DIR, "components", "profiles", "wechat"),
